...
class WV_Thankyou_Order_Details_ELement extends Widget_Base {

    public function get_name() {
        return 'wv-thankyou-order-details';
    }

    public function get_title() {
        return __( 'WV: Order Details', 'woovator-pro' );
    }
    ...
    protected function render() {
        ...
        <section class="woocommerce-order-details">
            ...
            <h2 class="woocommerce-order-details__title"><?php esc_html_e( 'Order details', 'woovator-pro' ); ?></h2>
        
            <table class="woocommerce-table woocommerce-table--order-details shop_table order_details">
        
                <thead>
                    <tr>
                        <th class="woocommerce-table__product-name product-name"><?php esc_html_e( 'Product', 'woovator-pro' ); ?></th>
                        <th class="woocommerce-table__product-table product-total"><?php esc_html_e( 'Total', 'woovator-pro' ); ?></th>
                    </tr>
                </thead>
                ...
                <tfoot>
                    ...
                    <?php if ( $order->get_customer_note() ) : ?>
                        <tr>
                            <th><?php esc_html_e( 'Note:', 'woovator-pro' ); ?></th>
...
Plugin::instance()->widgets_manager->register_widget_type( new WV_Thankyou_Order_Details_ELement() );