...
class WV_Myaccount_Order_ELement extends Widget_Base {

    public function get_name() {
        return 'wv-myaccount-order-list';
    }

    public function get_title() {
        return __( 'WV: My Account Order', 'woovator-pro' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'order_heading_style',
            array(
                'label' => __( 'Headings', 'woovator-pro' ),
        ...
        $this->start_controls_section(
            'order_number_style',
            [
                'label' => __( 'Order Number', 'woovator-pro' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'View Button', 'woovator-pro' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new WV_Myaccount_Order_ELement() );