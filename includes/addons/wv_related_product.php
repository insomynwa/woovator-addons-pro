...
class Woovator_Universal_Product_Related_Layout_Widget extends Widget_Base {

    public function get_name() {
        return 'woovator-related-product-custom';
    }
    
    public function get_title() {
        return __( 'WV: Related Product layout ( Custom ) ', 'woovator-pro' );
    }
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => __( 'Related Product', 'woovator-pro' ),
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} h2.wvrelated_product_title',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' =>'#444444',
                    'selectors' => [
                        '{{WRAPPER}} h2.wvrelated_product_title' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} h2.wvrelated_product_title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
    ...
    protected function render( $instance = [] ) {
        ...
        if( Plugin::instance()->editor->is_edit_mode() ){
            echo '<div class="related product">'.__( 'Related Product Universal Layout','woovator-pro' ).'</div>';
        }else{
        ...
        ?>
            <?php
                if( $settings['related_product_title'] !='' ){
                    echo '<div class="ht-row"><div class="ht-col-lg-12 ht-col-md-12 ht-col-sm-12 ht-col-xs-12"><h2 class="wvrelated_product_title">'.esc_html__( $settings['related_product_title'], 'woovator-pro' ).'</h2></div></div>';
                }
            ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new Woovator_Universal_Product_Related_Layout_Widget() );