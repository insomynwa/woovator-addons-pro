...
class Woovator_Universal_Product_Layout_Widget extends Widget_Base {
    ...
    public function get_title() {
        return __( 'WV: Universal Product Layout', 'woovator-pro' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Filter By', 'woovator-pro' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'recent',
                    'options' => [
                        'recent' => esc_html__( 'Recent Products', 'woovator-pro' ),
                        'featured' => esc_html__( 'Featured Products', 'woovator-pro' ),
                        'best_selling' => esc_html__( 'Best Selling Products', 'woovator-pro' ),
                        'sale' => esc_html__( 'Sale Products', 'woovator-pro' ),
                        'top_rated' => esc_html__( 'Top Rated Products', 'woovator-pro' ),
                        'mixed_order' => esc_html__( 'Random Products', 'woovator-pro' ),
                        'show_byid' => esc_html__( 'Show By Id', 'woovator-pro' ),
                        'show_byid_manually' => esc_html__( 'Add ID Manually', 'woovator-pro' ),
                    ],
                ]
            );
            ...
            $this->add_control(
                'show_by_tagwise',
                [
                    'label' => __( 'Show Product By Tag Wise', 'woovator-pro' ),
            ...
            $this->add_control(
                'woovator_product_grid_tags',
                [
                    'label' => esc_html__( 'Product Tags', 'woovator-pro' ),
                    'type' => Controls_Manager::SELECT2,
                    'label_block' => true,
                    'multiple' => true,
                    'options' => woovator_taxonomy_list( 'product_tag' ),
                    'condition' => [
                        'show_by_tagwise' => 'yes',
                        'woovator_product_grid_product_filter!' => 'show_byid',
                    ]
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Custom order', 'woovator-pro' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'no',
                ]
            ...
            $this->add_control(
                'order',
                [
                    'label' => esc_html__( 'order', 'woovator-pro' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'DESC',
                    'options' => [
                        'DESC'  => esc_html__('Descending','woovator-pro'),
                        'ASC'   => esc_html__('Ascending','woovator-pro'),
                    ],
                    'condition' => [
                        'woovator_custom_order' => 'yes',
                    ]
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Tab Menu Style', 'woovator-pro' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => __( 'Tab Menu Area Margin', 'woovator-pro' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
            ...
            $this->start_controls_tabs('product_tab_style_tabs');
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            'label' => __( 'Product tab menu background', 'woovator-pro' ),
                            'type' => Controls_Manager::COLOR,
                            'scheme' => [
                                'type' => Scheme_Color::get_type(),
                                'value' => Scheme_Color::COLOR_1,
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label' => __( 'Tab Menu padding', 'woovator-pro' ),
                            'type' => Controls_Manager::DIMENSIONS,
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label' => __( 'Tab Menu margin', 'woovator-pro' ),
                            'type' => Controls_Manager::DIMENSIONS,
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
    ...
    protected function render( $instance = [] ) {
        ...
        // Product tags Wise
        $get_product_tags = $settings['woovator_product_grid_tags'];
                                    ...
                                    if( $fetchproduct->have_posts() ){
                                        ?>
                                            <li><a class="<?php if($m==1){ echo 'htactive';}?>" href="#woovatortab<?php echo $tabuniqid.esc_attr($m);?>">
                                                <?php echo esc_attr( $prod_cats->name,'woovator-pro' );?>
                                            </a></li>
                                        <?php
                                    }
                                }
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="javascript:void(0);" class="woovatorquickview" data-quick-id="<?php the_ID();?>" >
                                                                    ...
                                                                    <span class="ht-product-action-tooltip"><?php esc_html_e('Quick View','woovator-pro'); ?></span>
                                                                </a>
                                                            </li>
                                                            <?php
